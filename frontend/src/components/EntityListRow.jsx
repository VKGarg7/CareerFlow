...
export default function EntityListRow({
  ...
  return (
    <div onClick={onClick}
      className={`group relative flex items-center gap-4 rounded-card border border-white/[0.06] border-l-4 ${accentBorder} bg-app-surface shadow-card transition-all duration-300 hover:-translate-y-0.5 hover:border-white/[0.1] hover:shadow-card-hover cursor-pointer px-5 py-3.5 overflow-hidden`}>
