...
const WORKSPACE_SCOPED_PREFIXES = ['/companies', '/applications', '/contacts', '/referrals', '/follow-ups', '/interviews', '/chat/sessions', '/goals', '/research-notes', '/opportunities', '/role-fit-evaluations', '/strategy-items', '/resumes', '/cover-letters', '/outreach-events', '/contact-follow-up-recommendations', '/action-items', '/timeline', '/deadlines', '/follow-up-rules', '/today']
