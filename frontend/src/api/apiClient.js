...
const WORKSPACE_SCOPED_PREFIXES = ['/companies', '/applications', '/recruiters', '/referrals', '/follow-ups', '/interviews', '/chat/sessions', '/goals', '/research-notes', '/opportunities', '/role-fit-evaluations', '/strategy-items']
