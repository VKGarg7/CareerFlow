...
describe('page smoke tests (batch C)', () => {
  it('Profile renders', async () => { await smoke(import('./Profile')) })
  it('Activity renders', async () => { await smoke(import('./Activity')) })
  it('AdminDashboard renders', async () => { await smoke(import('./AdminDashboard')) })
})

describe('Layout smoke test', () => {
  it('renders navigation with a child route', async () => {
    ...
    await waitFor(() => expect(container.innerHTML).toContain('Child content'))
  })
})
