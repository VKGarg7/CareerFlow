...
describe('page smoke tests (batch A)', () => {
  it('Landing renders', async () => { await smoke(import('./Landing')) })
  it('Dashboard renders', async () => { await smoke(import('./Dashboard')) })
  it('Companies renders', async () => { await smoke(import('./Companies')) })
  it('Applications renders', async () => { await smoke(import('./Applications')) })
})
